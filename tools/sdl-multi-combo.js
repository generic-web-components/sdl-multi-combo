...
var es6MainScriptUrl = s.src.replace(name, '/es6-bundled/src/components/sdl-data.js');s = script;
var es5MainScriptUrl = s.src.replace(name, '/es5-bundled/src/components/sdl-data.js');s = script;
